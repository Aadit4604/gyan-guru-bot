    ...
    async execute(interaction) {
        const commands = [
            ...
            },
            {
                ...
                items: [
                    { name: '/score', description: 'View your current gyan gola and streak', emoji: '🏅' },
            ...
            },
            {
                ...
                items: [
                    ...
                    { name: '/removepoints', description: 'Remove gyan gola from a user', emoji: '➖' },
                ]
            }
        ];
        ...
        // Add gyan gola and features embed
        const pointsEmbed = new EmbedBuilder()
            .setTitle('💰 Gyan Gola System')
            .setColor(0x10B981)
            .addFields(
                { name: '✅ Correct Answer', value: '+10 gyan gola', inline: true },
                { name: '💡 With Hint Used', value: '+5 gyan gola', inline: true },
                { name: '📅 Daily Quest', value: '+20 gyan gola + bonus', inline: true },
                { name: '⚔️ Win PvP Match', value: '+30 gyan gola', inline: true },
        ...
        const creditsEmbed = new EmbedBuilder()
            .setTitle('✨ Credits')
            .setColor(0x8B5CF6)
            .setDescription('Created by: **Aadit & Yash**\n\nThank you for using Gyan guru!');
        embeds.push(creditsEmbed);
